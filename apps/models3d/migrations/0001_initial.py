# Generated by Django 6.0.6 on 2026-08-17 01:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'قيد المراجعة'), ('resolved', 'تم الحل'), ('dismissed', 'مرفوض')], default='pending', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('saved_models', models.ManyToManyField(blank=True, related_name='saved_in_collections', to='models3d.model3d')),
